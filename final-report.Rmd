...
We trained our simple linear regression model on test data to predict SalePrice using all available predictors. To assess the performance of our model, we predicted the sale price of houses in the test set, and examine the test error rate by measuring the root mean squares error.
